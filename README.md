...
* You enter data by typing it in the scratchpad and then pressing the line select key next to the data field into which you want to insert it. (To type, use the MCDU keyboard.)
